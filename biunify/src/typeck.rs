...
use crate::ast;
use crate::core::*;
use compile_core::{SpanId, SpannedError as SyntaxError};
...
struct TypeVarBindings {
    ...
    m: HashMap<String, ((Value, Use), u32, SpanId)>,
}
impl TypeVarBindings {
    ...
    fn insert(&mut self, name: String, v: (Value, Use), span: SpanId) -> Option<SpanId> {
...
fn check_expr(
    ...
    match expr {
        BinOp((lhs_expr, lhs_span), (rhs_expr, rhs_span), op_type, _op, full_span) => {
            use ast::OpType::*;
